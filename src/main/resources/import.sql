...
-- object: it_agency.t_user | type: TABLE --
...
-- object: it_agency.t_information | type: TABLE --
-- DROP TABLE IF EXISTS it_agency.t_information CASCADE;
CREATE TABLE it_agency.t_information(
		id_information serial NOT NULL,
	  nom character varying(60),
	  prenom character varying(30),
	  phone character varying(20),
	  email character varying(70),
	CONSTRAINT c_information PRIMARY KEY (id_information)

);

-- ddl-end --
ALTER TABLE it_agency.t_information OWNER TO postgres;
-- ddl-end --

-- object: it_agency.t_offre | type: TABLE --
-- DROP TABLE IF EXISTS it_agency.t_offre CASCADE;
CREATE TABLE it_agency.t_offre(
		id_offre serial NOT NULL,
	  title character varying(120),
	  subtitle character varying(120),
	  location character varying(120),
	  resume character varying(400),
	  detail character varying(1000),
	CONSTRAINT c_offre PRIMARY KEY (id_offre)

);

-- ddl-end --
ALTER TABLE it_agency.t_offre OWNER TO postgres;
-- ddl-end --
